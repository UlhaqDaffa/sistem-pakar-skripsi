...
<head>
    ...
    <title>Spectra - Rekomendasi Topik</title>
    ...
    <div class="container mx-auto flex min-h-screen flex-col px-6 lg:px-8">
        <header class="w-full py-6">
            <nav class="flex items-center justify-between">
                ...
                <div class="hidden md:flex items-center space-x-10 mr-2 pr-24">
                ...
                @if (Route::has('login'))
                    @auth
                        <a href="{{ url('/dashboard') }}" class="group inline-flex items-center justify-center rounded-xl px-4 py-2 text-sm font-semibold bg-white dark:bg-gray-800/80 border border-gray-300 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                            Masuk
