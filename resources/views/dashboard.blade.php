    ...
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
            ...
            <a href="{{ route('rekomendasi') }}"
               ...
               @mouseleave="hovered = false">
                <span class="absolute inset-0 bg-indigo-600 transition-all duration-300 ease-out"
                      :class="{ 'w-full': hovered, 'w-0': !hovered }"></span>
        ...
        <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="bg-white dark:bg-neutral-800 p-0 rounded-xl shadow-md border dark:border-neutral-700 flex items-stretch justify-stretch">
                <a href="{{ route('ekspor') }}"
                   class="relative flex-1 flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-xl text-indigo-600 overflow-hidden group
                          focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                   x-data="{ hovered: false }"
                   @mouseenter="hovered = true"
                   @mouseleave="hovered = false">
